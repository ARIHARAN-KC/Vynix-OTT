...
const movies = [
  { id: 1, title: "Naruto", img: naruto, rating: 4.8, year: 2002, genre: "Action, Adventure", isNew: false },
  { id: 2, title: "Naruto Shippuden", img: narutoShippuden, rating: 4.9, year: 2007, genre: "Action, Drama", isNew: true },
  { id: 3, title: "Jujutsu Kaisen", img: jujutsuKaisen, rating: 4.2, year: 2017, genre: "Action, Sequel", isNew: true },
  { id: 4, title: "Attack on Titan", img: attackOnTitan, rating: 4.9, year: 2013, genre: "Dark Fantasy", isNew: false },
  { id: 5, title: "Demon Slayer", img: demonSlayer, rating: 4.7, year: 2019, genre: "Fantasy, Action", isNew: false },
  { id: 6, title: "One Piece", img: onePiece, rating: 4.8, year: 1999, genre: "Adventure, Comedy", isNew: false },
  { id: 7, title: "Jujutsu Kaisen S2", img: jujutsuKaisen, rating: 4.6, year: 2023, genre: "Supernatural", isNew: true },
  { id: 8, title: "My Hero Academia", img: myHeroAcademia, rating: 4.5, year: 2016, genre: "Superhero", isNew: false },
  { id: 9, title: "Boruto", img: boruto, rating: 4.0, year: 2017, genre: "Action, Sci-Fi", isNew: false },
  { id: 10, title: "Chainsaw Man", img: jujutsuKaisen, rating: 4.7, year: 2022, genre: "Horror, Action", isNew: true },
];
...
const Browse = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#0B0B17] via-[#1a1a2e] to-[#16213e] text-white min-h-screen font-['Inter'] pt-20">
      {/* <-- pt-20 pushes content below navbar */}
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="flex flex-wrap gap-3 mb-10">
          <button className="px-5 py-2.5 bg-gradient-to-r from-[#ff4ec0] to-[#7b2ff7] text-white rounded-full text-sm font-semibold">All</button>
          <button className="px-5 py-2.5 bg-white/5 backdrop-blur-md rounded-full text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 transition-colors">Action</button>
          <button className="px-5 py-2.5 bg-white/5 backdrop-blur-md rounded-full text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 transition-colors">Adventure</button>
          <button className="px-5 py-2.5 bg-white/5 backdrop-blur-md rounded-full text-sm font-semibold text-white/80 hover:text-white hover:bg-white/10 transition-colors">New Releases</button>
        </div>
